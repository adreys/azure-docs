...
| For ADDS and ADFS agents: FIPS (Federal Information Processing Standard) is disabled. | FIPS is only supported on Health agent for Sync since AAD Connect version 2.0.91.0. However is still not supported for Health agent for ADDS and ADFS |
